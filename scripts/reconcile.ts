...
checkInt('record count', rows.length, 1355);
...
check('KBank out', kbankOut, 101978.29);
check('card settlement (not spending)', settlement, 20000.00);
check('essential (out)', essential, 100618.11);
check('discretionary NET (refund-netted)', discNet, 151207.03);
check('transfer (out, excl settlement)', transfer, 70232.48);
check('NET TOTAL spending', netTotal, 322057.62, 1);
