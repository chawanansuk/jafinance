...
checkInt('record count', rows.length, 1327);
...
check('KBank out', kbankOut, 99156.00);
check('card settlement (not spending)', settlement, 20000.00);
check('essential (out)', essential, 100553.11);
check('discretionary NET (refund-netted)', discNet, 150900.03);
check('transfer (out, excl settlement)', transfer, 67782.19);
check('NET TOTAL spending', netTotal, 319235.33, 1);
