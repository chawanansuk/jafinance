...
checkInt('record count', rows.length, 656);
...
check('KBank out', kbankOut, 40278.17);
check('essential (out)', essential, 53708.27);
check('discretionary NET (refund-netted)', discNet, 85142.45);
check('transfer (out)', transfer, 34647.51);
check('NET TOTAL spending', netTotal, 173498.23, 1);
