...
checkInt('record count', rows.length, 1110);
...
check('KBank out', kbankOut, 86168.33);
check('card settlement (not spending)', settlement, 20000.00);
check('essential (out)', essential, 89704.90);
check('discretionary NET (refund-netted)', discNet, 121018.75);
check('transfer (out, excl settlement)', transfer, 62609.58);
check('NET TOTAL spending', netTotal, 273333.23, 1);
