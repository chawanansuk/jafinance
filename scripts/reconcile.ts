...
checkInt('record count', rows.length, 719);
...
check('KBank out', kbankOut, 48210.10);
check('essential (out)', essential, 54293.27);
check('discretionary NET (refund-netted)', discNet, 86963.45);
check('transfer (out)', transfer, 40173.44);
check('NET TOTAL spending', netTotal, 181430.16, 1);
