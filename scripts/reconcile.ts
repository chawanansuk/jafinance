...
checkInt('record count', rows.length, 905);
...
check('KBank out', kbankOut, 53550.10);
check('essential (out)', essential, 75404.40);
check('discretionary NET (refund-netted)', discNet, 99917.84);
check('transfer (out)', transfer, 51503.81);
check('NET TOTAL spending', netTotal, 226826.05, 1);
