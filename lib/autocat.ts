...
const KEYWORD_TABLE: { kw: string[]; category: string }[] = [
  ...
  { kw: ['lotus', 'โลตัส', 'tops', 'big c', 'bigc', 'makro', 'แม็คโคร', 'villa market', 'gourmet', 'foodland', 'tesco'], category: 'ห้าง/ซูเปอร์มาร์เก็ต' },
  ...
  { kw: ['hospital', 'โรงพยาบาล', 'รพ.', 'clinic', 'คลินิก', 'pharmacy', 'ร้านยา', 'dental', 'ทันตกรรม'], category: 'โรงพยาบาล/สุขภาพ' },
