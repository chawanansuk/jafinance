...
const KEYWORD_TABLE: { kw: string[]; category: string }[] = [
  ...
  { kw: ['sushiro', 'mk ', 'sukishi', 'yayoi', 'fast food', 'kfc', 'mcdonald', 'burger', 'pizza', 'ร้านอาหาร', 'restaurant', 'ตามสั่ง', 'noodle', 'ก๋วยเตี๋ยว', 'izakaya', 'katsu', 'shabu', 'fuji'], category: 'อาหาร/ร้านอาหาร' },
  ...
  { kw: ['hospital', 'hosp', 'christian hos', 'โรงพยาบาล', 'รพ.', 'clinic', 'คลินิก', 'pharmacy', 'ร้านยา', 'dental', 'ทันตกรรม', 'watsons', 'boots', 'guardian'], category: 'โรงพยาบาล/สุขภาพ' },
