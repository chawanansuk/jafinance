...
const KEYWORD_TABLE: { kw: string[]; category: string; venue?: true }[] = [
  ...
  { kw: ['hospital', 'hosp', 'christian hos', 'โรงพยาบาล', 'รพ.', 'จิตเวช', 'clinic', 'คลินิก', 'pharma', 'ร้านยา', 'dental', 'ทันตกรรม', 'watsons', 'boots', 'guardian', 'iserviceccp'], category: 'โรงพยาบาล/สุขภาพ' },
