...
| รายการ | ค่า |
|---|---|
| รายจ่ายสุทธิรวม (net, รวม transfer, ไม่รวมชำระบัตร) | 322,058 |
| UOB net (gross 250,761.35 − refund 10,682.02) | 240,079.33 |
| KBank | 101,978.29 |
| ชำระบัตรเครดิต (ไม่นับเป็นรายจ่าย) | 20,000.00 |
| จำเป็น / ลดได้(net) / โอน-ถอน | 100,618 / 151,207 / 70,232 |
...
## ข้อมูล
`data/transactions.json` — 1,355 รายการ ผ่านการ reconcile กับสลิปแล้ว
ขอบเขต: UOB ต่อเนื่อง 20 ก.พ.–20 ส.ค. · KBank เป็นช่วงๆ ถึง 22 ก.ย. (ดู disclaimer ในแอพ)
