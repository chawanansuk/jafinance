...
| รายการ | ค่า |
|---|---|
| รายจ่ายสุทธิรวม (net, รวม transfer) | 181,430 |
| UOB net (gross 143,902.08 − refund 10,682.02) | 133,220.06 |
| KBank | 48,210.10 |
| จำเป็น / ลดได้(net) / โอน-ถอน | 54,293 / 86,963 / 40,173 |
...
## ข้อมูล
`data/transactions.json` — 719 รายการ ผ่านการ reconcile กับสลิปแล้ว
ขอบเขต: UOB ต่อเนื่อง 20 ก.พ.–20 พ.ค. · KBank เป็นช่วงๆ ถึง 10 ก.ค. (ดู disclaimer ในแอพ)
