...
| รายการ | ค่า |
|---|---|
| รายจ่ายสุทธิรวม (net, รวม transfer, ไม่รวมชำระบัตร) | 273,333 |
| UOB net (gross 217,846.92 − refund 10,682.02) | 207,164.90 |
| KBank | 86,168.33 |
| ชำระบัตรเครดิต (ไม่นับเป็นรายจ่าย) | 20,000.00 |
| จำเป็น / ลดได้(net) / โอน-ถอน | 88,268 / 124,133 / 60,932 |
...
## ข้อมูล
`data/transactions.json` — 1,110 รายการ ผ่านการ reconcile กับสลิปแล้ว
ขอบเขต: UOB ต่อเนื่อง 20 ก.พ.–20 ก.ค. · KBank เป็นช่วงๆ ถึง 13 ส.ค. (ดู disclaimer ในแอพ)
