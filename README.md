...
| รายการ | ค่า |
|---|---|
| รายจ่ายสุทธิรวม (net, รวม transfer, ไม่รวมชำระบัตร) | 311,541 |
| UOB net (gross 250,761.35 − refund 10,682.02) | 240,079.33 |
| KBank | 91,461.49 |
| ชำระบัตรเครดิต (ไม่นับเป็นรายจ่าย) | 20,000.00 |
| จำเป็น / ลดได้(net) / โอน-ถอน | 100,253 / 149,224 / 62,064 |
...
## ข้อมูล
`data/transactions.json` — 1,275 รายการ ผ่านการ reconcile กับสลิปแล้ว
ขอบเขต: UOB ต่อเนื่อง 20 ก.พ.–20 ส.ค. · KBank เป็นช่วงๆ ถึง 31 ส.ค. (ดู disclaimer ในแอพ)
