...
| รายการ | ค่า |
|---|---|
| รายจ่ายสุทธิรวม (net, รวม transfer, ไม่รวมชำระบัตร) | 278,626 |
| UOB net (gross 217,846.92 − refund 10,682.02) | 207,164.90 |
| KBank | 91,461.49 |
| ชำระบัตรเครดิต (ไม่นับเป็นรายจ่าย) | 20,000.00 |
| จำเป็น / ลดได้(net) / โอน-ถอน | 88,566 / 126,479 / 63,581 |
...
## ข้อมูล
`data/transactions.json` — 1,142 รายการ ผ่านการ reconcile กับสลิปแล้ว
ขอบเขต: UOB ต่อเนื่อง 20 ก.พ.–20 ก.ค. · KBank เป็นช่วงๆ ถึง 31 ส.ค. (ดู disclaimer ในแอพ)
